...
public final class YsmClientRuntime {
    ...
    public static void openImportFolder() {
        ...
        try {
            ...
            Util.getPlatform().openFile(importsRoot.toFile());
        ...
        try {
            ...
            if (client != null && client.player != null) {
                client.player.displayClientMessage(
                    net.minecraft.network.chat.Component.literal("YSM import picker is unavailable here. The imports folder was opened; drop .ysm, .zip, or raw model folders there and press Reload."),
                    false
                );
            }
            return null;
